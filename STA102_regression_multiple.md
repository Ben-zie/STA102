...
- $CP$ de Mallows : mesure le **biais** introduit par un modèle imbriqué sous-spécifié. Un modèle imbriqué satisfaisant devrai avoir un $Cp$ égal au **nombre de ses paramètres**. 
